		...
		<form class="form form-horizontal" id="form-article-add">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" placeholder="输入奖品名称" value="{{$prize->p_name}}" name="p_name" style="width: 200px;">
				</div>
			</div>
			<div class="row cl" >
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<img src="{{$prize->p_img}}" alt="no img" style="width: 100px;height: 100px;">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3">url地址：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input class="input-text" type="text" name="p_img" readonly="readonly" value="{{$prize->p_img}}">
				</div>
			</div>
			<div class="row cl">
